...
python eval_get_signals_non-e2e.py -l records/model/cvd__still__1/best.pth
python train_non-e2e.py -f 2 -m cvd -ts still
python eval_get_signals_non-e2e.py -l records/model/cvd__still__2/best.pth
python train_non-e2e.py -f 3 -m cvd -ts still
python eval_get_signals_non-e2e.py -l records/model/cvd__still__3/best.pth
python train_non-e2e.py -f 4 -m cvd -ts still
python eval_get_signals_non-e2e.py -l records/model/cvd__still__4/best.pth
python train_non-e2e.py -f 5 -m cvd -ts still
python eval_get_signals_non-e2e.py -l records/model/cvd__still__5/best.pth
