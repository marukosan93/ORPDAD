...
#Pearson loss, but we use the MCC loss for all experiments as the methods perform better with MCC. Mostly due to MCC being less sensitive to synchronisation errors.
...
# MCC loss from Gideon, John, and Simon Stent. "The way to my heart is through contrastive learning: Remote photoplethysmography from unlabelled video." Proceedings of the IEEE/CVF international conference on computer vision. 2021.
...
# Use some key phrases as inputs to select scenario sets for training and testing
