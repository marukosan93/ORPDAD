...
python eval_get_signals_e2e.py -l records/model/physnet__still__1/best.pth
python train_e2e.py -f 2 -m physnet -ts still
python eval_get_signals_e2e.py -l records/model/physnet__still__2/best.pth
python train_e2e.py -f 3 -m physnet -ts still
python eval_get_signals_e2e.py -l records/model/physnet__still__3/best.pth
python train_e2e.py -f 4 -m physnet -ts still
python eval_get_signals_e2e.py -l records/model/physnet__still__4/best.pth
python train_e2e.py -f 5 -m physnet -ts still
python eval_get_signals_e2e.py -l records/model/physnet__still__5/best.pth
