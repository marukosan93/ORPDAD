...
The shared data may be used only in strict accordance with a mutually signed Data Transfer Agreement, which terms dictate the usage of the data (academic, non-commercial, non-distributable). For publications not all subjects have given consent for their images to be used in graphics. Only images from subject IDs 001-017,019-022,025-030 maybe be used in publications. It is prohibited to use sample images from IDs 018, 023, 024.
